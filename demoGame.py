...
worldRooms = {
    ...
    'North Y Street': {
        DESC: 'The northern end of Y Street has really gone down hill. Pot holes are everywhere, as are stray cats,'
              ' rats, and wombats.',
        NORTH: 'Town Gate',
        WEST: 'Thief Guild',
        EAST: 'Bakery',
    ...
    'Town Bridge': {
        DESC: 'You stand on a long wooden bridge, a deep moat lies on either side, you can see something beneath '
              'the water moving suspiciously.',
        SOUTH: 'Town Gate',
        EAST: 'Moat',
        WEST: 'Moat',
        NORTH: 'Road',
        GROUND: []},
    'Moat': {
        DESC: 'You jump in the water, it feels nice and refreshing on this warm day. Not too long after you feel '
        ...
        GROUND: []},
    'Town Gate': {
        DESC: 'The town gate sits before you, a guard on either side, making sure monsters stay at bay should '
              'they attempt to break in. Since it\'s been peaceful for the past few years, the guards are currently'
              ' napping.',
        NORTH: 'Town Bridge',
        SOUTH: 'North Y Street',
        GROUND: ['Warning Sign']},
    'Thief Guild': {
        DESC: 'The Thief Guild is a dark den of unprincipled types. You clutch your purse (though several other people'
              ' here would like to clutch your purse as well).',
        SOUTH: 'West X Street',
        EAST: 'North Y Street',
        GROUND: ['Lock Picks', 'Silly Glasses']},
    'Bakery': {
        DESC: 'The delightful smell of meat pies fills the air, making you hungry. The baker flashes a grin, as he'
        ...
        GROUND: ['Shop Howto']},
    'West X Street': {
        DESC: 'West X Street is the rich section of town. So rich, they paved the streets with gold. This probably was'
        ...
        GROUND: []},
    'Used Anvils Store': {
        DESC: 'The anvil store has anvils of all types and sizes, each previously-owned but still in servicable '
    ...
    'East X Street': {
        ...
        GROUND: []},
    'Blacksmith': {
        DESC: 'The blacksmith loudly hammers a new sword over her anvil. Swords, axes, butter knives all line the walls'
              ' of her workshop, available for a price.',
        NORTH: 'West X Street',
        EAST: 'South Y Street',
        SHOP: ['Sword', 'War Axe', 'Chainmail T-Shirt'],
        GROUND: ['Anvil', 'Shop Howto']},
    'South Y Street': {
        DESC: 'The Christmas Carolers of South Y Street are famous for all legally changing their name to Carol. They'
        ...
        GROUND: []},
    'Wizard Tower': {
        DESC: 'Zanny magical antics are afoot in the world-famous Wizard Tower. Cauldrons bubble, rats talk, and books'
              ' float midair in this center of magical discovery.',
        NORTH: 'East X Street',
        UP: 'Observation Deck',
        GROUND: ['Crystal Ball', 'Floating Book', 'Floating Book']},
    'Observation Deck': {
        DESC: 'You can see the entire town from the top of the Wizard Tower. Everybody looks like ants, especially the '
...
worldItems = {
    'Welcome Sign': {
        ...
        LONGDESC: 'The welcome sign reads, "Welcome to this text adventure demo. You can type "help" for a list of '
                  'commands to use."',
        TAKEABLE: False,
        DESCWORDS: ['welcome', 'sign']},
    'Warning Sign': {
        GROUNDDESC: 'A warning sign sits in front of the gate. There\'s something written in bright red letters.',
        SHORTDESC: 'a warning sign',
        LONGDESC: 'The warning sign reads, "Do NOT jump into moat! There are no lifeguards on duty!"',
        TAKEABLE: False,
        DESCWORDS: ['warning', 'sign']},
    'Road Sign': {
        GROUNDDESC: 'A road sign stands here.',
        SHORTDESC: 'a road sign',
        LONGDESC: 'The road sign reads, "<- West to Fairville    East to Summershores ->."',
        TAKEABLE: False,
        DESCWORDS: ['road', 'sign']},
    'Worn Note': {
        GROUNDDESC: 'A worn note lays on the ground, it\'s crumpled, yellowed, and smells a bit like wet moss.',
        SHORTDESC: 'a worn note',
        LONGDESC: 'The note reads: "Wandering into the forest may sound fun, but be warned, there are monsters waiting'
                  'to strike."',
        TAKEABLE: False,
        DESCWORDS: ['worn', 'note']},
    ...
    'War Axe': {
        ...
        SHORTDESC: 'a war axe',
        LONGDESC: 'The mighty war axe is made with antimony impurities from a fallen star, rendering it '
    ...
    'Crystal Ball': {
        ...
        LONGDESC: 'The crystal ball swirls with mystical energy, forming the words "Answer Unclear. Check Again'
                  ' Later."',
    ...
    'README Note': {
        ...
        LONGDESC: 'The README note reads, "Welcome to the text adventure demo. Be sure to check out the source code to'
                  ' see how this game is put together."',
        EDIBLE: True,
        DESCWORDS: ['readme', 'note']},
    'Shop Howto': {
        GROUNDDESC: 'A "Shopping HOWTO" note rests on the ground.',
        SHORTDESC: 'a shopping howto',
        LONGDESC: 'The note reads, "When you are at a shop, you can type "list" to show what is for sale. "buy <item>"'
                  ' will add it to your inventory, or you can sell an item in your inventory with "sell <item>".'
                  ' (Currently, money is not implemented in this program.)',
        EDIBLE: True,
...
def getAllFirstDescWords(item_list):
...
def getFirstItemMatchingDesc(desc, item_list):
    item_list = list(set(item_list))  # make item_list unique
    for item in item_list:
...
def getAllItemsMatchingDesc(desc, item_list):
    item_list = list(set(item_list))  # make item_list unique
    matchingItems = []
    for item in item_list:
        if desc in worldItems[item][DESCWORDS]:
